<section class="admin-page-header">
    <h2>Create Block Type</h2>
    <p>Create a reusable block template.</p>
</section>

<section class="admin-grid">
    <form method="post" action="/admin/block-types/create" class="stat-card admin-form">
        ...
        <div class="form-actions">
            <button type="submit">Create Block Type</button>
            <a href="/admin/block-types">Cancel</a>
        </div>
    </form>
</section>
